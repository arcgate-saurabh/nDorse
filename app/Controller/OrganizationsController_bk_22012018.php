...
//                    $totalinvitations[$target_id] = array("invitation_accepted" => $invitation_accepted, "invitation_pending" => $invitation_pending);
    ...
    public function info($id) {
        ...
        if ($this->Session->check('Auth.User.role') != "1") {
            ...
            //}
            //======end
            $org_user_data = $this->User->find('all', array("order" => "User.id DESC", 'limit' => 20, 'conditions' => array('UserOrganization.organization_id' => $id, 'UserOrganization.user_role' => array(2, 3), 'UserOrganization.status' => array(0, 1, 3)), 'order' => 'UserOrganization.user_role'));
