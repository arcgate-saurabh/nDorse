...
//                    exit;
                    ?>
                    <section class="lady-lake farhan hand pending-announcement"  id="announcement_<?php echo $announcements['Announcement']["id"]; ?>" announcement_id ="<?php echo $announcements['Announcement']["id"]; ?>">
                        <div class="row">
                            <div class="col-md-3 pull-left" >
                                <div class="col-md-8 text-center">
                                    ...
                                    <div class="far-user "><?php echo $announcements['0']['posted_user_name']; ?></div>
