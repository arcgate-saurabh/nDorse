...
<div class="container">
    ...
    <section>
        ...
        <?php echo $this->Form->input('user_curr_org_id', array('class' => 'form-control', 'label' => false, 'type' => 'hidden', 'id' => 'user_curr_org_id', 'value' => $userCurrntOrgID)); ?>
        <div class="row">
                ...
                <section>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-10">
                                <?php
                                //$decodedUsername = $this->App->decodeData($userdata['User']['username']);
                                $decodedUsername = $userdata['User']['username'];
                                echo $this->Form->input('username', array('placeholder' => 'Username', 'class' => 'form-control', 'readonly' => 'readonly', 'value' => $decodedUsername, 'label' => false));
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-10">
                                <?php
//                                $decodedFname = $this->App->decodeData($userdata['User']['fname']);
                                $decodedFname = $userdata['User']['fname'];
                                echo $this->Form->input('fname', array('placeholder' => 'First Name', 'class' => 'form-control', 'value' => $decodedFname, 'label' => false));
                                ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="col-md-10">
                                <?php
//                                $decodedLname = $this->App->decodeData($userdata['User']['lname']);
                                $decodedLname = $userdata['User']['lname'];
                                echo $this->Form->input('lname', array('placeholder' => 'Last Name', 'class' => 'form-control', 'value' => $decodedLname, 'label' => false));
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-2">
                                <div class="labelCus require">Mobile</div>
                            </div>
                            <div class="col-md-5">
...
//                                    pr($this->request->data);
                                    echo $this->Form->input('department_id', array('empty' => 'Select Department', 'class' => 'form-control textbox', 'label' => false, 'options' => $orgDepartment, 'selected' => $this->request->data['User']['dept_id'], 'data-url' => Router::url(array('controller' => 'ajax', 'action' => 'states'))));
                                    ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="col-md-10">
                                <div class = "select-style">
                                    <?php echo $this->Form->input('entityid', array('empty' => 'Select Sub org', 'class' => 'form-control textbox', 'label' => false, 'options' => $orgSubOrg, 'selected' => $this->request->data['User']['entity_id'], 'data-url' => Router::url(array('controller' => 'ajax', 'action' => 'states')))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-10">
                                <div class = "select-style">
                                    <?php echo $this->Form->input('jobtitle_id', array('empty' => 'Select Job title', 'class' => 'form-control textbox', 'label' => false, 'options' => $orgJobTitle, 'selected' => $this->request->data['User']['jobtitle_id'], 'data-url' => Router::url(array('controller' => 'ajax', 'action' => 'states')))); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="col-md-2">
                                <div class="labelCus">Sub Center</div>
                            </div>
                            <div class="col-md-10">
                                <div class = "select-style">
                                    <?php echo $this->Form->input('subcenter_id', array('empty' => 'Select Sub center', 'class' => 'form-control textbox', 'label' => false, 'options' => $subCenterArray, 'selected' => $this->request->data['User']['subcenter_id'], 'data-url' => Router::url(array('controller' => 'ajax', 'action' => 'states')))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="container-fluid footer-bg">
    <div class="container">
        <div class="row">
            <div class="pull-right">
                <button type="button" class="btn btn-default" id="editcuserformcancel">Cancel</button>
                <button type="button" class="btn btn-default" id="editcuserformsubmit">Save</button>
