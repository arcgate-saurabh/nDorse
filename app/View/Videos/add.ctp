...
//    echo $org_user_role;
    ...
    <section>
        <div class="row">
            ...
            <div class="col-md-12 MT30" > <span><img src="<?php echo Router::url('/', true); ?>img/addClient.png"  align="left" width="30" alt="" data-toggle="modal" data-target=".js_emojis" class="hand addstickerplusicon"/>
                    <h3 class="attach-img atch-stkr-tag"> &nbsp;Attach Stickers</h3>
                </span>
