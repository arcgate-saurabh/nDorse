    ...
    <section style="padding:10px;">
        ...
        <div class="select-date col-md-12">
            <div class="col-md-3 form-group">
                ...
                <?php echo $this->Form->input('startdate', array('placeholder' => 'Select a Start Date', 'type' => 'text', 'id' => 'datepicker_start', 'class' => 'form-control date', 'label' => false)); ?>
            </div>
            <div class="col-md-3 form-group">
                <label> To</label>
                <?php echo $this->Form->input('enddate', array('placeholder' => 'Select a End Date', 'type' => 'text', 'id' => 'datepicker_end', 'class' => 'form-control date', 'label' => false)); ?>
            </div>
            <div class="col-md-6 ">
