...
<?php
$data = array(
    "textcenter" => "All DAISY Nominations",
    "righttabs" => "3",
        ...
        <div id="filter-nDorsements" class="collapse">
            ...
            <div class="col-md-2">
                <div style="vertical-align:bottom; display:table-cell; height:170px;">
                    <h4></h4>
                    <button type="submit" id="submitdaisyfilterendorsement" class="btn btn-info">Apply</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="search-icn col-md-12" style="margin-bottom:10px;">
          ...
          <!--  <input type="text" class="form-control" id="searchallendorsement" onkeyup="searchallendorsement(this.value)" placeholder="Filter Items...">-->
            <input type="text" class="form-control" id="searchalldaisyendorsement" placeholder="Filter Items...">
        </div>
        <div class="col-md-12 charts-height" id="allendorsementsdata">
            <div data-example-id="striped-table"  class="row bs-example">
                ...
                <div class="leaderborad"> All DAISY Nominations</div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo $this->webroot; ?>img/pancake.png" alt="" /> </a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="javascript:void(0)" onclick="saveallendorsement('allendorsementsearching',<?php echo $organization_id; ?>, 'allendorsements', 'daisy')">Save as Spreadsheet</a></li>
                  ...
                  <!--<p>Total Endorsements:-<span id="totalendorsements"><?php //echo count($allvaluesendorsement);             ?></span></p> -->
                    <div class="scroll-header">
                        <table class="table table-striped table-hover" >
                            ...
                            <tr id="tableheader">
                                <th><div class="col-endor">Nominator</div></th>
                                <th><div class="col-endor">Nominator Title</div></th>
                                <th><div class="col-endor">Nominator Email</div></th>
                                <th><div class="col-endor">Nominator Mobile</div></th>
                                <th><div class="col-endor">Nominee</div></th>
                                <th><div class="col-endor">Nominee Department  /Unit</div></th>
                                <th><div class="col-endor">Sub center /Facility</div></th>
                                <th><div class="endor-date">Nomination Date</div></th>
                                <th><div class="endor-date">Award</div></th>
...
<!--                                <th><div class="">Reply to nDorsement</div></th>
                            ...
                            <tbody id="allendorsementsearching">
                                <?php // pr($allvaluesendorsement); //exit?>
                                <?php //echo $this->Element("allendorsementslisting", array("allvaluesendorsement" => $allvaluesendorsement, 'showAttachments' => true,'portal' =>'daisy','DAISYAwards'=> $DAISYAwards)); ?>
