...
<div style="position: absolute; overflow: hidden; width: 100%; height: 100%; z-index: 1">
    <div id="imageGallery" style="height: 100vh">
        <img id="image" src="<?php echo Router::url('/', true); ?>img/profile-screen-1.jpg" width="100%" />
    </div>
    ...
    <div id="gain" style="position: absolute; bottom: 50px; width: 100%; display: flex; justify-content: center; align-items:  center; z-index: 10;">
        <button id="profile_login_walkthrough" class="btn btn-primary js_profile_login_walkthrough" data-user-id = "<?php echo $loggedinUser['id']; ?>">Upload Later</button>
        <!-- <button id="previous" type="button">Previous</button> -->

        <button id="next" type="button" class="btn btn-primary">Next</button>

        <button id="finish" type="button" class=" btn btn-primary js_profile_login_walkthrough" data-user-id = "<?php echo $loggedinUser['id']; ?>">Finish</button>    
    </div>
