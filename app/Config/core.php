 ...
 */
	...
	Configure::write('Error', array(
		'handler' => 'NdorseErrorHandler::handleError',
		'level' => E_ALL & ~E_DEPRECATED,
		'trace' => true
	));
 ...
 */
	Configure::write('Session', array(
				'defaults' => 'php',
				'timeout' => 60, // The session will timeout after 30 minutes of inactivity
				'cookieTimeout' => 1440, // The session cookie will live for at most 24 hours, this does not effect session timeouts
				//'checkAgent' => false,
				//'autoRegenerate' => true, // causes the session expiration time to reset on each page load
                                    'ini' => array(
                                    'session.gc_maxlifetime' => 3600 // 36 hours
                                )
	));
 ...
 */
	Configure::write('Security.salt', 'RDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '376859309657453542496749683645');
